...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event)  { 
    	...
    	try {
    		...
    		// Reset DataBase
    		// uncomment to drop all tables //TODO: Comment This part
			try {
		...
		if (!tableExists){
			...
			try {
                ...
                for (BookOfUser bookOfUser : booksOfUser) {
                    pstmt.setString(1, new Integer(bookOfUser.getBookId()).toString());
                    pstmt.setString(2, new Integer(bookOfUser.getUserId()).toString());
                    pstmt.setString(3, new Boolean (bookOfUser.getIsOpen()).toString());
                    pstmt.setString(4, new Boolean (bookOfUser.getIsLiked()).toString());
                    pstmt.setString(5, new Boolean (bookOfUser.getIsReviewed()).toString());
                    pstmt.setString(6, new Integer(bookOfUser.getScrollLocation()).toString());
